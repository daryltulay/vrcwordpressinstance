(function($) {
	...
	jQuery(document.body).on('touchstart', '.mg_touchswipe .mg_nav_prev, .mg_touchswipe .mg_nav_next', function(){
		var pid = jQuery(this).attr('id').substr(7);
		mg_switch_item(pid);
	});
	...
	jQuery(document.body).on('click', '#mg_close', function(){
		mg_close_lightbox();
	});
	jQuery(document.body).on('touchstart', '.mg_touchswipe #mg_close', function(){
		mg_close_lightbox();
	});
